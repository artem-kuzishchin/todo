...
class ToDoApp {
    ...
    processForm(submittedForm: SubmitEvent):void{
        submittedForm.preventDefault();
        const text = <HTMLInputElement> document.getElementById("newToDoText");
        if(text.value != ""){
    ...
    saveEdit(id:number){
        let editInput =<HTMLInputElement> document.getElementById("editInput");
